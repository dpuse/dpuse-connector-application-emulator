...
| check              | alt+ctrl+shift+c | List the dependencies in the project that are outdated. Lists dependences that need updating vis the 'npm install[name]@latest' command. |
